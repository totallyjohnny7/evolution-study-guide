...
window.COURSE = {
  ...
  "subtitle": "Exam 1 + 2 + 3 consolidated · 56 sections · 407 MCQs · 87 flashcards · 170+ diagrams",
  "hasVisuals": true,
  "chapters": [
    {
      "id": "ch_s_evo_mech",
  ...
  "flashcards": [
    {
      "q": "Natural Selection?",
      "a": "**Natural selection** = differential survival and reproduction of individuals based on heritable traits.",
      "chapterId": "ch_s_evo_mech",
      "sectionId": "s_ns",
      "source": "exam1",
      "analogy": "Like a sieve: environment filters which alleles pass to the next generation.",
      "hint": "Needs 3 ingredients: variation, heritability, differential reproduction. Miss any → no evolution."
    },
    {
      "q": "Mnemonic — Natural Selection",
      "a": "&ldquo;**V-F-H-P**: Variation, Fitness differences, Heritable, Predictable change&rdquo; = the 4 conditions that guarantee natural selection produces evolution.",
      "chapterId": "ch_s_evo_mech",
      "sectionId": "s_ns",
      "source": "exam1",
      "analogy": "Like a sieve: environment filters which alleles pass to the next generation.",
    ...
    {
      "q": "Genetic Drift?",
      "a": "**Genetic drift** = random fluctuation of allele frequencies due to chance sampling.",
      "chapterId": "ch_s_evo_mech",
      "sectionId": "s_drift",
      "source": "exam1",
      "analogy": "Coin flips in a small crowd get noisy fast — random allele change, small populations feel it most.",
      "hint": "Drift effect ∝ 1/N. BIG population = drift is tiny. SMALL population = drift dominates."
    },
    {
      "q": "Gene Flow & Mutation?",
      "a": "**Gene flow** = movement of alleles between populations via migration.",
      "chapterId": "ch_s_evo_mech",
      "sectionId": "s_gf_mut",
      "source": "exam1",
      "analogy": "Students transfer between schools and swap slang — gene flow mixes populations, keeps them similar.",
      "hint": "Gene flow OPPOSES speciation. More migration = populations converge, not diverge."
    },
    {
      "q": "Applied Evolutionary Scenarios: Drug Resistance, Influenza & Domestication?",
      "a": "All three applied scenarios share the same evolutionary logic: **heritable variation** in a target trait exists in the population before selection begins, **selection** is non-random and consistently favors one variant, and the population **responds** with allele frequency change across generations.",
      "chapterId": "ch_s_evo_mech",
      "sectionId": "s_applied",
      "source": "exam1",
      "analogy": "Two recipes for the same cake (gene) — vanilla and chocolate are alleles.",
      "hint": "allele comes from Greek allelon = \"of one another.\" Alternative forms of the same gene."
    },
    {
      "q": "Inbreeding & Non-Random Mating?",
      "a": "**Inbreeding** = mating between closely related individuals.",
      "chapterId": "ch_s_evo_mech",
      "sectionId": "s_inbreeding",
      "source": "exam1",
      "analogy": "Cousin-marriages stack recessive diseases. Inbreeding depression = fewer reshuffled alleles.",
      "hint": "Inbreeding INCREASES homozygosity. Rare recessive alleles get exposed when both copies match."
    },
    {
      "q": "Weinberg Equilibrium?",
      "a": "The **Hardy-Weinberg equilibrium (HWE)** is the null hypothesis of population genetics: in a large, randomly mating population with no selection, mutation, gene flow, or drift, genotype frequencies p² + 2pq + q² = 1 remain constant across generations.",
      "chapterId": "ch_s_genetics",
      "sectionId": "s_hwe",
      "source": "exam1",
      "analogy": "A calm pond — no wind, no rocks, no drain. Allele frequencies stay still. Ripple = evolution.",
      "hint": "HWE holds only if: no selection, no mutation, no migration, no drift, random mating. Break ANY → evolution."
    },
    {
      "q": "Quantitative Genetics & Heritability?",
      "a": "Quantitative traits are continuous (height, weight, beak size).",
      "chapterId": "ch_s_genetics",
      "sectionId": "s_quant_gen",
      "source": "exam1",
      "analogy": "h² = how much of trait variance comes from genes vs environment. 0 = all learned, 1 = all DNA.",
      "hint": "R = h² × S. No h², no response to selection. Breeder's equation: \"how fast does this evolve?\""
    },
    {
      "q": "Alleles: Dominant, Recessive & Additive?",
      "a": "**Dominant alleles** mask the expression of recessive alleles in heterozygotes (Aa looks like AA).",
      "chapterId": "ch_s_genetics",
      "sectionId": "s_alleles",
      "source": "exam1",
      "analogy": "Two recipes for the same cake (gene) — vanilla and chocolate are alleles.",
    ...
    {
      "q": "Phenotypic Plasticity & Reaction Norms?",
      "a": "**Phenotypic plasticity** = one genotype produces different phenotypes in different environments.",
      "chapterId": "ch_s_genetics",
      "sectionId": "s_plasticity",
      "source": "exam1",
      "analogy": "The recipe written in your DNA.",
      "hint": "geno = gene; type = kind. The genetic makeup, not what you see."
    },
    {
      "q": "Genome Structure & Gene Expression Regulation?",
      "a": "Eukaryotic genomes (including human) contain: protein-coding genes (~1.5% of human genome), pseudogenes (non-functional copies of genes), mobile genetic elements/transposons (~45% of human genome), introns, regulatory sequences, and other non-coding DNA.",
      "chapterId": "ch_s_genetics",
      "sectionId": "s_genome",
      "source": "exam1",
      "analogy": "ESS = stable poker strategy. If everyone plays it, no one wins more by switching.",
      "hint": "Not necessarily OPTIMAL — just UNINVADABLE. Classic: hawk-dove equilibrium."
    },
    {
      "q": "Key Figures in Evolutionary Thought?",
      "a": "**Scala Naturae / Great Chain of Being**: pre-Darwinian concept organizing all life in a fixed, ranked hierarchy (minerals → plants → animals → humans → angels).",
      "chapterId": "ch_s_hist",
      "sectionId": "s_key_figures",
      "source": "exam1",
      "analogy": "Darwin and Wallace independently arrived at natural selection. Ideas whose time had come.",
      "hint": "Wallace's 1858 letter from Indonesia forced Darwin to publish. They co-presented at the Linnean Society."
    },
    {
      "q": "Mnemonic — Key Figures in Evolutionary Thought",
      "a": "&ldquo;**Lamarck Lifts Wrong Weights; Darwin Wins**&rdquo; = Lamarck (wrong mechanism but evolutionary), Lyell (deep time), William Smith (stratigraphy/extinction), Darwin (natural selection), Wallace (co-discoverer who forced Darwin to publish).",
      "chapterId": "ch_s_hist",
      "sectionId": "s_key_figures",
      "source": "exam1",
      "analogy": "Like a sieve: environment filters which alleles pass to the next generation.",
    ...
    {
      "q": "Scientific Method: Hypothesis vs. Theory?",
      "a": "**Hypothesis:** A tentative, testable explanation for a specific observation.",
      "chapterId": "ch_s_hist",
      "sectionId": "s_sci_method",
      "source": "exam1",
      "analogy": "Think of an everyday situation that follows the same pattern — concrete examples lock concepts in.",
      "hint": "Break the term into its Latin/Greek roots — the meaning is often hiding in the word itself."
    },
    {
      "q": "Evolution of Complex Traits (Vertebrate Eye)?",
      "a": "Complex traits evolve GRADUALLY via many small mutations, each providing a slight fitness advantage.",
      "chapterId": "ch_s_ch10",
      "sectionId": "s_evoeye",
      "source": "exam2",
      "analogy": "Typos in DNA photocopying — usually harmless, rarely brilliant, occasionally catastrophic.",
      "hint": "Mutations are RANDOM w.r.t. fitness. Selection is what's non-random. Mutation ≠ adaptation."
    },
    {
      "q": "Homology vs. Analogy in Complex Traits?",
      "a": "**Homologous traits** = similar structures INHERITED from a common ancestor (same developmental origin).",
      "chapterId": "ch_s_ch10",
      "sectionId": "s_homoana",
      "source": "exam2",
      "analogy": "Your arm and a whale flipper — same bones, different jobs. Same blueprint, different house.",
      "hint": "homo = same, logy = relation. SAME origin — regardless of current function."
    },
    {
      "q": "The Paradox of Sex & Its Benefits?",
      "a": "Sexual reproduction has a **twofold cost**: in an asexual population, EVERY individual reproduces.",
      "chapterId": "ch_s_ch11",
      "sectionId": "s_whysex",
      "source": "exam2",
      "analogy": "A population = people who could potentially interbreed. Interbreeding group in a location at a time.",
      "hint": "Population ≠ species. A species can contain MANY populations with gene flow varying between them."
    },
    {
      "q": "Sexual Selection & Anisogamy?",
      "a": "**Sexual selection** = selection arising from differential MATING success.",
      "chapterId": "ch_s_ch11",
      "sectionId": "s_sexsel",
      "source": "exam2",
      "analogy": "Peacock's tail — useless for survival, gold for dating. Mate choice drives burden traits.",
      "hint": "Intrasexual = males fighting males (antlers). Intersexual = females choosing (tails)."
    },
    {
      "q": "Life History Trade-offs?",
      "a": "Life history = the schedule of an organism's survival, growth, and reproduction across its lifespan.",
      "chapterId": "ch_s_ch12",
      "sectionId": "s_lifehistory",
      "source": "exam2",
      "analogy": "r-selected = many cheap kids (fish). Boom-bust environments favor quantity.",
      "hint": "r = intrinsic rate of increase. High r = many young, little care, unstable environments."
    },
    {
      "q": "Aging: Mutation Accumulation & Antagonistic Pleiotropy?",
      "a": "Aging (senescence) persists despite natural selection, which usually removes deleterious traits.",
      "chapterId": "ch_s_ch12",
      "sectionId": "s_aging",
      "source": "exam2",
      "analogy": "Like a sieve: environment filters which alleles pass to the next generation.",
    ...
    {
      "q": "Coevolutionary Arms Races & Geographic Mosaic?",
      "a": "**Coevolution** = reciprocal evolutionary change between interacting species.",
      "chapterId": "ch_s_ch15",
      "sectionId": "s_coevo_basics",
      "source": "exam2",
      "analogy": "Red Queen: run just to stay in place. Host-parasite, predator-prey — everyone evolving to not fall behind.",
      "hint": "Red Queen from Alice: \"It takes all the running you can do, to keep in the same place.\""
    },
    {
      "q": "Mimicry & Endosymbiosis?",
      "a": "**Batesian mimicry:** A palatable (harmless) species mimics an unpalatable (toxic/dangerous) species.",
      "chapterId": "ch_s_ch15",
      "sectionId": "s_mimicry",
      "source": "exam2",
      "analogy": "Harmless fly wears wasp costume — scares predators for free. Works when real wasps are around.",
      "hint": "Named after H. W. Bates. One species MIMICS a DANGEROUS model. Parasitic on the model."
    },
    {
      "q": "Evolutionarily Stable Strategy (ESS)?",
      "a": "An **ESS** (Maynard Smith & Price, 1973) is a strategy that, once adopted by most members of a population, CANNOT be invaded by any alternative rare mutant strategy.",
      "chapterId": "ch_s_ch16",
      "sectionId": "s_ess",
      "source": "exam2",
      "analogy": "ESS = stable poker strategy. If everyone plays it, no one wins more by switching.",
    ...
    {
      "q": "Kin Selection, Altruism & Hamilton's Rule?",
      "a": "**Altruism** (biological) = behavior that REDUCES the actor's direct fitness while INCREASING the recipient's direct fitness.",
      "chapterId": "ch_s_ch16",
      "sectionId": "s_altruism",
      "source": "exam2",
      "analogy": "Fitness = number of offspring reaching reproductive age. Not strongest, not smartest — most fertile.",
      "hint": "Fitness is ALWAYS relative to other genotypes in the SAME environment. Change environment → fitness changes."
    },
    {
      "q": "Mnemonic — Kin Selection, Altruism & Hamilton's Rule",
      "a": "Haldane quip: &ldquo;**I would lay down my life for 2 brothers or 8 cousins**&rdquo; = 2 × r(0.5) = 1.0 = same as saving yourself. 8 × r(0.125) = 1.0. Break even = worth it; more = favored by kin selection.",
      "chapterId": "ch_s_ch16",
      "sectionId": "s_altruism",
      "source": "exam2",
      "analogy": "\"Die for 2 brothers or 8 cousins\" — Haldane. Genes help copies of themselves even in other bodies.",
      "hint": "Hamilton's rule: rB > C. r=relatedness, B=benefit to recipient, C=cost to actor."
    },
    {
      "q": "⚠ Can C-14 date a T. rex fossil (~66 mya)?",
      "a": "❌ NO. Half-life = 5,730 yrs. After ~250,000 yrs all C-14 is gone. Use U-Pb or K-Ar for ancient fossils. C-14 only works on recent material (<50,000 yrs).",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Half-life = wait time for half the popcorn to pop. Rate known + amount left → elapsed time.",
      "hint": "Half-life NEVER changes with temperature or pressure. Pick the isotope with a half-life matching your sample age."
    },
    {
      "q": "⚠ \"Reptiles\" excluding birds — monophyletic or paraphyletic?",
      "a": "Paraphyletic ✗ Excludes birds which ARE theropod dinosaurs. Crocodilians more closely related to birds than lizards. Include birds to make it monophyletic.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Like taking a whole branch off a tree — cut includes the ancestor and every descendant.",
      "hint": "mono = one; phyly = tribe. ONE tribe = the WHOLE group sharing an ancestor."
    },
    {
      "q": "⚠ Largest mass extinction: K-T or End-Permian?",
      "a": "End-Permian (~252 mya) = LARGEST (~96% loss). K-T (~66 mya) = 76% = most famous. \"Great Dying\" vs \"Dinosaur Killer.\" Severity ≠ Fame.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Jenga tower after too many pieces pulled — ecosystem collapses. 5 times in Earth's history.",
      "hint": "Big Five: Ordovician, Devonian, Permian (worst — 96% marine species), Triassic, K-Pg (dinos)."
    },
    {
      "q": "⚠ Did antibiotics CAUSE resistance mutations?",
      "a": "NO. Mutations are random and pre-existing. Antibiotics KILL susceptibles and SELECT FOR pre-existing resistant variants. No directed mutation. Antibiotics reveal and amplify existing variation.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Typos in DNA photocopying — usually harmless, rarely brilliant, occasionally catastrophic.",
    ...
    },
    {
      ...
      "a": "NO. Humans and chimps share a common ancestor ~7 mya. We are SISTER LINEAGES. Neither is the ancestor of the other. Both evolved since the split.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Think of an everyday situation that follows the same pattern — concrete examples lock concepts in.",
    ...
    {
      "q": "⚠ Bipedalism before or after large brains?",
      "a": "BIPEDALISM FIRST (~6–7 mya). Large brain expansion came later. Australopithecus walked fully upright with ~450cc ape-sized brain. Sequence matters for exams.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Lucy walked upright 3.2 mya — bipedalism came BEFORE big brains in our lineage.",
      "hint": "Lucy = Australopithecus afarensis, Ethiopia, 1974. Named after \"Lucy in the Sky with Diamonds.\""
    },
    {
      "q": "⚠ BSC fails in which 3 scenarios?",
      "a": "1) Fossils (can't test gene flow). 2) Asexual species (bacteria/archaea). 3) Hybridizing species (fertile hybrids exist). Know all three for Robbins' scenario questions.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "A fossil is a biological photograph pressed into stone — we see a biased fragment of the past.",
      "hint": "Most organisms NEVER fossilize. Hard parts in sediment = overrepresented; soft bodies = rare."
    },
    {
      "q": "⚠ Mule = hybrid inviability or sterility?",
      "a": "Hybrid STERILITY. Mules are healthy and vigorous but CANNOT REPRODUCE — 63 chromosomes can't pair in meiosis. Inviability = can't survive. Sterility = survives, can't reproduce.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "A mule (donkey × horse) — alive, strong, but sterile. Nature's \"doesn't combine.\"",
      "hint": "Hybrid sterility = postzygotic. F1 may live; F2 may be sickly → \"hybrid breakdown.\""
    },
    {
      "q": "⚠ Island equilibrium = same NUMBER or same SPECIES?",
      "a": "Same NUMBER but species IDENTITY changes (turnover). Some go extinct, new ones colonize. Equilibrium diversity is stable; which species are present is not.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Species = a group that usually makes fertile offspring together, usually not with other groups.",
      "hint": "No single species concept works for all life. Use whatever concept fits the question (biological, ecological, phylogenetic)."
    },
    {
      "q": "⚠ Do pathogens always evolve LOWER virulence?",
      "a": "NO. Virulence evolves to maximize pathogen FITNESS. Water-borne pathogens (cholera) can maintain HIGH virulence — transmission doesn't need an active host. Evolution has no direction.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Fitness = number of offspring reaching reproductive age. Not strongest, not smartest — most fertile.",
    ...
    {
      "q": "⚠ Is FOXP2 \"the language gene\"?",
      "a": "Oversimplification. FOXP2 = transcription factor for fine orofacial motor control. Functions in mice + birds too. Necessary but NOT sufficient for language. 2 human-specific amino acid changes after chimp split.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "ESS = stable poker strategy. If everyone plays it, no one wins more by switching.",
    ...
    {
      "q": "⚠ Global diversity formula — include immigration?",
      "a": "NO. Global: D2 = D1 + originations − extinctions ONLY. Immigration + emigration cancel globally. Only matter at local/regional scale. Robbins fill-in-the-blank target.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Students transfer between schools and swap slang — gene flow mixes populations, keeps them similar.",
    ...
    {
      "q": "⚠ Dispersal vs vicariance — who moves?",
      "a": "DISPERSAL = organisms MOVE to new area. VICARIANCE = organisms STAY, BARRIER appears. Hawaiian crickets = dispersal. Panama Isthmus = vicariance. Active vs passive movement.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Mendel's peas: traits inherit as discrete units, not blended paint. 3:1, 9:3:3:1 — genetics' cheat codes.",
      "hint": "Mendel published 1866, ignored until 1900 rediscovery. \"Fathered\" genetics in a monastery garden."
    },
    {
      "q": "⚠ Neanderthal brain vs H. sapiens — who has bigger?",
      "a": "Neanderthals = LARGER or equal (~1500cc vs ~1350cc). Brain size ≠ survival advantage. Went extinct despite bigger brains. Organization + behavior matter more than raw volume.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Neanderthals buried their dead, made tools; ~1-4% of your DNA is theirs.",
      "hint": "Named after Neander Valley (Germany). Went extinct ~40 kya, but we interbred first."
    },
    {
      "q": "⚠ Miller-Urey produced what exactly?",
      "a": "Amino acids (20+ kinds) from inorganic material + simulated lightning. NOT cells. NOT DNA. NOT life. Only proves building blocks can form abiotically. Don't overstate.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Think of an everyday situation that follows the same pattern — concrete examples lock concepts in.",
    ...
    {
      "q": "⚠ Feathers evolved FOR flight — true or false?",
      "a": "FALSE. Feathers evolved in non-flying theropods for insulation/display. Arms too short to fly early on. Flight evolved LATER when feathers were co-opted = EXAPTATION. Original function ≠ current function.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Think of an everyday situation that follows the same pattern — concrete examples lock concepts in.",
    ...
    {
      "q": "⚠ Antagonistic pleiotropy vs mutation accumulation?",
      "a": "Antagonistic pleiotropy = one allele with BOTH early benefits AND late costs (testosterone). Mutation accumulation = late mutations with NO early benefit accumulate because selection is weak. Does it HELP early? Yes = antagonistic pleiotropy.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Typos in DNA photocopying — usually harmless, rarely brilliant, occasionally catastrophic.",
    ...
    {
      "q": "⚠ Synapomorphy vs ancestral character — which defines a clade?",
      "a": "SYNAPOMORPHY (shared DERIVED character) only. Ancestral characters shared by many groups tell you NOTHING about relationships within those groups. Only derived characters evolved in the immediate ancestor of a specific clade are informative.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Think of an everyday situation that follows the same pattern — concrete examples lock concepts in.",
    ...
    {
      "q": "⚠ Allopolyploidy needs geographic isolation to form new species?",
      "a": "FALSE. Allopolyploidy creates immediate reproductive isolation (different ploidy level) in a SINGLE GENERATION with no geographic separation needed. One of the only true routes to instant sympatric speciation. ~50% of flowering plants have polyploid ancestry.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Can two breeds meet and make fertile puppies? If yes, same species. If sterile (mule), isolated.",
      "hint": "BSC applies only to SEXUAL species. No good for asexuals or extinct fossils."
    },
    {
      "q": "⚠ What causes hybrid male sterility before female sterility? (Haldane's Rule)",
      "a": "Heterogametic sex (XY males) has recessive incompatibility alleles on the single X EXPOSED (no second X to mask them). Homogametic (XX females) have a backup. In birds, females are ZW (heterogametic) so FEMALES are sterile first. Rule = heterogametic sex goes first.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "A mule (donkey × horse) — alive, strong, but sterile. Nature's \"doesn't combine.\"",
    ...
    {
      "q": "⚠ Sickle cell in malaria region — which genotype has HIGHEST fitness?",
      "a": "HbA/HbS HETEROZYGOTE has HIGHEST fitness in malaria-endemic regions. HbA/HbA = susceptible to malaria. HbS/HbS = severe anemia. HbA/HbS = protected from malaria WITHOUT anemia. Classic heterozygote advantage (overdominance).",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Fitness = number of offspring reaching reproductive age. Not strongest, not smartest — most fertile.",
    ...
    {
      "q": "⚠ Where is Denisovan DNA found (vs. Neanderthal DNA)?",
      "a": "Denisovan DNA: primarily Melanesians/Pacific Islanders (~3–6%) + some Asians. Neanderthal DNA: ALL non-African modern humans (~1–4%). Denisovan = Pacific/Asian region. Neanderthal = global non-African. Africans have neither (never encountered either species).",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Neanderthals buried their dead, made tools; ~1-4% of your DNA is theirs.",
    ...
    {
      "q": "⚠ Great Oxidation Event — who caused it and when?",
      "a": "Cyanobacteria evolving oxygenic photosynthesis (~2.6 bya) → O2 accumulated → Great Oxidation Event ~2.4 bya. Consequence: mass extinction of anaerobes; ozone layer formed; aerobic respiration became possible. NOT from eukaryotes (they came AFTER GOE).",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Jenga tower after too many pieces pulled — ecosystem collapses. 5 times in Earth's history.",
    ...
    {
      "q": "⚠ Ne vs. N — which is always smaller?",
      "a": "Ne (effective population size) is ALWAYS smaller than N (census population). Ne reflects actual breeding individuals contributing equally. Unequal sex ratios, variance in reproductive success, and bottlenecks reduce Ne below N. Conservation targets Ne ≥ 50 (short-term) and Ne ≥ 500 (long-term).",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Cheetahs squeezed through a genetic needle — crash wipes out variation. Survivors ≠ representative sample.",
      "hint": "Bottleneck ≠ founder. Bottleneck = population CRASHES; founder = SMALL group LEAVES to start new pop."
    },
    {
      "q": "⚠ Cancer = evolution? What does that mean?",
      "a": "YES. Cancer IS somatic evolution: heritable variation (somatic mutations) + natural selection (cells with proliferation advantages replicate more) = adaptation of tumor. Drug resistance in cancer = same mechanism as antibiotic resistance: pre-existing resistant variants selected for when drug kills susceptibles.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Like a sieve: environment filters which alleles pass to the next generation.",
    ...
    {
      "q": "⚠ Anatomically modern vs. behaviorally modern H. sapiens — which came first and by how long?",
      "a": "ANATOMICAL modernity (~195 kya) came ~100,000 years BEFORE BEHAVIORAL modernity (~70–100 kya). Modern skeleton first; art, symbols, long-distance trade, ornaments came later. Don't equate looking modern with acting modern.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Think of an everyday situation that follows the same pattern — concrete examples lock concepts in.",
    ...
    {
      "q": "⚠ Wallace Line: what's on each side?",
      "a": "WEST: Asian fauna (primates, tigers, elephants, Asian deer). EAST: Australasian fauna (marsupials, cockatoos, birds of paradise). A deep ocean channel persisted even during ice ages — discovered by Alfred Russel Wallace 1859. Classic vicariance in biogeography.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Darwin and Wallace independently arrived at natural selection. Ideas whose time had come.",
    ...
    {
      "q": "⚠ Trophy hunting: which direction does it drive evolution vs. natural selection?",
      "a": "OPPOSITE directions. Natural selection favors LARGE horns/tusks (male competition, mate attraction). Trophy hunting removes LARGE-horned/tusked individuals → selects for SMALL traits. Bighorn sheep: 20% horn size decline over 30 years. Elephants: tusklessness increasing in poached populations.",
      "chapterId": "mixed",
      "sectionId": "traps",
      "source": "exam3",
      "analogy": "Like a sieve: environment filters which alleles pass to the next generation.",
    ...
    {
      "q": "Age of the Earth & Radiometric Dating?",
      "a": "Earth is ~4.568 billion years old.",
      "chapterId": "ch3",
      "sectionId": "c31",
      "source": "exam3",
      "analogy": "Half-life = wait time for half the popcorn to pop. Rate known + amount left → elapsed time.",
    ...
    {
      "q": "Mnemonic — Age of the Earth & Radiometric Dating",
      "a": "“**C**ool **K**ids **U**sually **R**ock” = C-14 (recent), K-Ar (medium), U-Pb (old), Rb-Sr (ancient).",
      "chapterId": "ch3",
      "sectionId": "c31",
      "source": "exam3",
      "analogy": "Half-life = wait time for half the popcorn to pop. Rate known + amount left → elapsed time.",
    ...
    {
      "q": "Origin of Life (Abiogenesis)?",
      "a": "**Abiogenesis** = life from non-living chemistry.",
      "chapterId": "ch3",
      "sectionId": "c32",
      "source": "exam3",
      "analogy": "Think of an everyday situation that follows the same pattern — concrete examples lock concepts in.",
    ...
    {
      "q": "Early Life Milestones?",
      "a": "**Biomarkers** = molecular evidence of life in ancient rocks (carbon isotope ratios, lipids).",
      "chapterId": "ch3",
      "sectionId": "c33",
      "source": "exam3",
      "analogy": "Think of an everyday situation that follows the same pattern — concrete examples lock concepts in.",
    ...
    {
      "q": "Mnemonic — Geologic Timeline",
      "a": "“**Old Salamanders Don't Climb Poorly Traveled Jungle Crags**” = Ordovician, Silurian, Devonian, Carboniferous, Permian, Triassic, Jurassic, Cretaceous",
      "chapterId": "ch3",
      "sectionId": "c34",
      "source": "exam3",
      "analogy": "Jenga tower after too many pieces pulled — ecosystem collapses. 5 times in Earth's history.",
    ...
    {
      "q": "Tree Components?",
      "a": "A **phylogenetic tree** = hypothesis about evolutionary relationships.",
      "chapterId": "ch4",
      "sectionId": "c41",
      "source": "exam3",
      "analogy": "A family tree — tips = alive today, nodes = common ancestors.",
      "hint": "clade = branch. Read like an upside-down tree: time flows from root (old) to tips (now)."
    },
    {
      "q": "Synapomorphies & Mono/Paraphyletic Groups?",
      "a": "A **synapomorphy** = shared DERIVED character that evolved in the immediate ancestor of a clade and was inherited by ALL descendants.",
      "chapterId": "ch4",
      "sectionId": "c42",
      "source": "exam3",
      "analogy": "Like \"reptiles excluding birds\" — a branch with one twig pointedly left out. Incomplete.",
      "hint": "para = beside/alongside → group is BESIDE the full group, missing a piece."
    },
    {
      "q": "Mnemonic — Synapomorphies & Mono/Paraphyletic Groups",
      "a": "“**MONO = All Kids Come Home. PARA = Some Kids Left. POLY = Different Parents Showed Up.**”",
      "chapterId": "ch4",
      "sectionId": "c42",
      "source": "exam3",
      "analogy": "Like \"reptiles excluding birds\" — a branch with one twig pointedly left out. Incomplete.",
    ...
    {
      "q": "Parsimony & Homoplasy?",
      "a": "**Parsimony**: prefer the tree requiring FEWEST evolutionary changes.",
      "chapterId": "ch4",
      "sectionId": "c43",
      "source": "exam3",
      "analogy": "Occam's razor for trees: fewest trait-changes explanation is usually right.",
      "hint": "parsimony = \"frugal.\" The SIMPLEST tree (fewest steps) beats a flashier one."
    },
    {
      "q": "Exaptation + Case Studies (Tiktaalik, Feathers)?",
      "a": "An **exaptation** = trait evolved for function A, later co-opted for function B.",
      "chapterId": "ch4",
      "sectionId": "c44",
      "source": "exam3",
      "analogy": "Think of an everyday situation that follows the same pattern — concrete examples lock concepts in.",
    ...
    {
      "q": "The Four Species Concepts?",
      "a": "~25 definitions exist.",
      "chapterId": "ch13",
      "sectionId": "c131",
      "source": "exam3",
      "analogy": "Species = a group that usually makes fertile offspring together, usually not with other groups.",
    ...
    {
      "q": "Mnemonic — The Four Species Concepts",
    ...
    {
      "q": "Allopatric vs. Sympatric Speciation?",
      "a": "Apple trees introduced ~400 ya.",
      "chapterId": "ch13",
      "sectionId": "c133",
      "source": "exam3",
      "analogy": "Friends moved to different towns → different slang → eventually can't hang out at all.",
      "hint": "allo = other; patric = place. OTHER PLACE → isolated by geography."
    },
    {
      "q": "Allopolyploidy (Instant Speciation) & Haldane's Rule?",
      "a": "**Allopolyploidy** = hybridization between two different species + whole-genome duplication.",
      "chapterId": "ch13",
      "sectionId": "c133b",
      "source": "exam3",
      "analogy": "A mule (donkey × horse) — alive, strong, but sterile. Nature's \"doesn't combine.\"",
    ...
    {
      "q": "Dispersal vs. Vicariance (Biogeography)?",
      "a": "**Biogeography** = study of spatial and temporal distribution of biodiversity.",
      "chapterId": "ch14",
      "sectionId": "c141",
      "source": "exam3",
      "analogy": "Biogeography = nature's postal zones. Why kangaroos are in Australia, not Canada.",
      "hint": "Historical biogeography = PAST movements. Ecological biogeography = CURRENT distributions."
    },
    {
      "q": "Standing Diversity Math?",
      "a": "**Standing diversity (D)** = number of species present at a given time.",
      "chapterId": "ch14",
      "sectionId": "c142",
      "source": "exam3",
      "analogy": "Species = a group that usually makes fertile offspring together, usually not with other groups.",
    ...
    {
      "q": "Mnemonic — Standing Diversity Math",
      "a": "“**Diversity = Species Births minus Species Deaths**” at global scale. λ = birth rate of species. μ = death rate of species.",
      "chapterId": "ch14",
      "sectionId": "c142",
      "source": "exam3",
      "analogy": "Species = a group that usually makes fertile offspring together, usually not with other groups.",
    ...
    },
    {
      ...
      "a": "**Adaptive radiation** = λ greatly exceeds μ → rapid diversification into many ecological roles.",
      "chapterId": "ch14",
      "sectionId": "c143",
      "source": "exam3",
      "analogy": "One ancestor, many descendant forms, fast. Galápagos finches and Hawaiian honeycreepers are classic.",
      "hint": "Trigger: ECOLOGICAL OPPORTUNITY (new habitat, empty niches). Followed by rapid diversification."
    },
    {
      "q": "Mnemonic — Mass Extinctions: The Big 5 + 6th",
      "a": "“**Old Dogs Play Tennis Carefully**” = Ordovician, Devonian, Permian, Triassic, Cretaceous. Permian = WORST. Cretaceous = most famous.",
      "chapterId": "ch14",
      "sectionId": "c144",
      "source": "exam3",
      "analogy": "Jenga tower after too many pieces pulled — ecosystem collapses. 5 times in Earth's history.",
    ...
    {
      "q": "Island Biogeography (MacArthur & Wilson 1967)?",
      "a": "Island species richness reflects a **dynamic equilibrium** between immigration (adds species) and extinction (removes species).",
      "chapterId": "ch14",
      "sectionId": "c145",
      "source": "exam3",
      "analogy": "Students transfer between schools and swap slang — gene flow mixes populations, keeps them similar.",
    ...
    {
      "q": "Wallace Line, Conservation Genetics & 50/500 Rule?",
      "a": "A sharp biogeographic boundary running through the Malay Archipelago (between Bali and Lombok; between Borneo and Sulawesi).",
      "chapterId": "ch14",
      "sectionId": "c145b",
      "source": "exam3",
      "analogy": "Darwin and Wallace independently arrived at natural selection. Ideas whose time had come.",
    ...
    {
      "q": "Humans as Selective Agents?",
      "a": "Humans impose intense, consistent, directional selection on other species through hunting, medicine, agriculture, and habitat change.",
      "chapterId": "ch8",
      "sectionId": "c81",
      "source": "exam3",
      "analogy": "Species = a group that usually makes fertile offspring together, usually not with other groups.",
    ...
    {
      "q": "Specific Human-Driven Evolution Examples?",
      "a": "Trophy hunting selectively removes individuals with the LARGEST traits (biggest horns = most desirable trophy).",
      "chapterId": "ch8",
      "sectionId": "c81b",
      "source": "exam3",
      "analogy": "Think of an everyday situation that follows the same pattern — concrete examples lock concepts in.",
    ...
    {
      "q": "Humans as Primates?",
      "a": "Linnaeus (1758) placed humans in Order Primates based on anatomical similarities: forward-facing eyes, gripping hands with nails, large relative brain.",
      "chapterId": "ch17",
      "sectionId": "c171",
      "source": "exam3",
      "analogy": "Think of an everyday situation that follows the same pattern — concrete examples lock concepts in.",
    ...
    {
      "q": "Mnemonic — Hominin Timeline",
      "a": "“**Sadly Australians Have Eaten Neanderthal Snacks**” = Sahelanthropus, Ardipithecus, Australopithecus, Habilis, Erectus, Neanderthal, Sapiens. Oldest → most recent.",
      "chapterId": "ch17",
      "sectionId": "c172",
      "source": "exam3",
      "analogy": "Lucy walked upright 3.2 mya — bipedalism came BEFORE big brains in our lineage.",
    ...
    {
      "q": "Bipedalism?",
      "a": "Habitual upright locomotion on two legs.",
      "chapterId": "ch17",
      "sectionId": "c173",
      "source": "exam3",
      "analogy": "Lucy walked upright 3.2 mya — bipedalism came BEFORE big brains in our lineage.",
    ...
    {
      "q": "Brain, Tools & Language (FOXP2)?",
      "a": "Brain size tripled from ~450cc (Australopithecus) to ~1350cc (H.",
      "chapterId": "ch17",
      "sectionId": "c174",
      "source": "exam3",
      "analogy": "Lucy walked upright 3.2 mya — bipedalism came BEFORE big brains in our lineage.",
    ...
    {
      "q": "Neanderthals, Modern Humans & Out of Africa?",
      "a": "**Out of Africa hypothesis:** anatomically modern H.",
      "chapterId": "ch17",
      "sectionId": "c175",
      "source": "exam3",
      "analogy": "Neanderthals buried their dead, made tools; ~1-4% of your DNA is theirs.",
    ...
    {
      "q": "Denisovans, Anatomically vs. Behaviorally Modern, Brain Evolution?",
      "a": "An archaic hominin group identified primarily through DNA from a finger bone in Denisova Cave, Siberia (2010).",
      "chapterId": "ch17",
      "sectionId": "c175b",
      "source": "exam3",
      "analogy": "Hominin = humans + all close extinct relatives (Neanderthals, Australopithecus). Narrow.",
      "hint": "Hominin ≠ hominid. Hominid = great apes + humans. Hominin = humans + extinct close relatives only."
    },
    {
      "q": "Why We Get Sick: 6 Evolutionary Reasons (Nesse 2005)?",
      "a": "**Evolutionary medicine** = applying evolutionary biology to understand disease vulnerability.",
      "chapterId": "ch18",
      "sectionId": "c181",
      "source": "exam3",
      "analogy": "ESS = stable poker strategy. If everyone plays it, no one wins more by switching.",
    ...
    {
      "q": "Mnemonic — Why We Get Sick: 6 Evolutionary Reasons (Nesse 2005)",
      "a": "“**Pathogens Laugh, Trade-offs Really Embarrass Anyone**” = Pathogens faster, Lag/mismatch, Trade-offs, Restraints from history, (ant)Agonistic pleiotropy, Apparent disease = adaptation.",
      "chapterId": "ch18",
      "sectionId": "c181",
      "source": "exam3",
      "analogy": "A trait shaped by selection to do a job — like a screwdriver evolved from a general stick.",
      "hint": "Adaptation = trait + FUNCTION + SELECTION history. Not every useful feature is an adaptation."
    },
    {
      "q": "Evolving Pathogens & Virulence?",
      "a": "**Virulence** = degree of harm a pathogen causes its host.",
      "chapterId": "ch18",
      "sectionId": "c182",
      "source": "exam3",
      "analogy": "Think of an everyday situation that follows the same pattern — concrete examples lock concepts in.",
    ...
    {
      "q": "Evolutionary Mismatch & Conserved Gene Networks?",
      "a": "**Evolutionary mismatch** = modern diseases arising because our evolved biology is mismatched to current environments.",
      "chapterId": "ch18",
      "sectionId": "c183",
      "source": "exam3",
      "analogy": "Mismatch: bodies evolved for scarcity, environment now has abundance. Obesity + diabetes = evolution's revenge.",
      "hint": "Mismatch hypothesis: ancestral environment ≠ modern environment → maladaptation to the NEW world."
    },
    {
      "q": "Sickle Cell, Cancer as Somatic Evolution & More Trade-offs?",
      "a": "Sickle cell is caused by a single nucleotide change in beta-globin: Glutamic acid → Valine (Glu6Val).",
      "chapterId": "ch18",
      "sectionId": "c183b",
      "source": "exam3",
      "analogy": "Can't be huge + fast + fertile + long-lived — energy budget forces you to pick.",
      "hint": "Trade-offs are WHY perfect organisms don't exist. Every gain has a cost."
    },
    {
